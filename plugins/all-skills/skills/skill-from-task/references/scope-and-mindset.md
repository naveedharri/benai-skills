...
The first version is decent, not final. Build a small working skill; improvement comes from using it (see evals-and-improvement.md). Do not attempt a complete, polished skill in one pass.
